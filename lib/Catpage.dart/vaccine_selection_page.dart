...
// ในคลาส VaccineSelectionPage แก้ไข type parameter ให้ใช้ dynamic
...
// ทำงานกับข้อมูล dynamic ใน _VaccineSelectionPageState เพื่อรองรับทั้งกรณี bool และ Map
class _VaccineSelectionPageState extends State<VaccineSelectionPage> {
  ...
  int getSelectedCount() {
    ...
    vaccinationGroups.forEach((_, vaccines) {
      vaccines.forEach((_, data) {
        if (data is Map && data['isSelected'] == true) {
          count++;
        }
      });
    });
